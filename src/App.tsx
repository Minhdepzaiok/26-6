...
import {
  ...
  Signal, ShieldAlert, Info, List, Server
} from 'lucide-react';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              ...
              <div className="lg:col-span-5 flex flex-col gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-black text-slate-200 uppercase tracking-wider">Dự án định lượng (AI CEO)</span>
                </div>
                <PredictionTab 
                  analytics={analytics} 
                  arParams={arParams}
              ...
              <div className="lg:col-span-7 flex flex-col gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-black text-slate-200 uppercase tracking-wider">Kết quả kỳ quay</span>
                </div>
                <HistoryTab
                  data={combinedData}
